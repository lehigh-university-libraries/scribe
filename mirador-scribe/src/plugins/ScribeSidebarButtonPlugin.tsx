...
interface ScribeSidebarButtonProps {
  size?: TypographyProps['variant'];
}

function ScribeSidebarButton({ size = 'caption' }: ScribeSidebarButtonProps) {
  return (
    <Typography
      component="span"
      sx={{
...
(ScribeSidebarButton as typeof ScribeSidebarButton & { value: string }).value = 'scribeEditor';
  ...
  config: {
    translations: {
      en: {
        ...
        scribeEditorTranscribeDialogDescription: 'Choose visible lines to retranscribe, or send the full document page.',
        scribeEditorTranscribeDialogTitle: 'Retranscribe Text',
        scribeEditorTranscribeDocument: 'Retranscribe Document',
        scribeEditorTranscribeSelectVisible: 'Select all visible lines',
