...
then ensure the [backup](backup-restore.md) and [job recovery](job-recovery.md)
procedures have been exercised. Use [observability](observability.md) for
health, logs, metrics, audit metadata, queue state, and alert response.
