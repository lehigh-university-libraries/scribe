...
module "cloud_compose" {
  source = "https://github.com/libops/cloud-compose/archive/889335d615fc3f32db2c66a604f14a3b1a3e8189.tar.gz//cloud-compose-889335d615fc3f32db2c66a604f14a3b1a3e8189/modules/gcp-foundation?archive=tar.gz"
  providers = {
    google      = google
