...
> development branch until every release criterion in `AGENTS.md` is backed by
...
make docs-serve        # local Zensical documentation
...
The complete developer and operator guide starts at [docs/index.md](docs/index.md):
...
Build the site with pinned Zensical using `make docs`.
