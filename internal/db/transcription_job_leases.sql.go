...
const markTranscriptionJobLeasedManual = `-- name: MarkTranscriptionJobLeasedManual :exec
UPDATE transcription_jobs
SET
  status = 'running',
...
func (q *Queries) MarkTranscriptionJobLeasedManual(ctx context.Context, arg MarkTranscriptionJobLeasedManualParams) error {
	_, err := q.db.ExecContext(ctx, markTranscriptionJobLeasedManual, arg.LeaseUntil, arg.LockedBy, arg.ID)
	return err
}
