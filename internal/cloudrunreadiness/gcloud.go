...
var (
	...
	browserManifestSubstageMarkerPattern        = regexp.MustCompile(`^browser readiness manifest substage: (library-navigation|import-form|import-request|import-request-body|import-upstream-request|import-upstream-response|import-response-delivery|import-response-status|import-response-settlement|import-contract|editor-navigation|editor-mount|first-canvas|first-image|first-annotations|first-publication|second-image|second-canvas|second-annotations|second-overlay|second-publication)$`)
