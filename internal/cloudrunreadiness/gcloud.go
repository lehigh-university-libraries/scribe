...
var (
	...
	browserManifestSubstageMarkerPattern        = regexp.MustCompile(`^browser readiness manifest substage: (library-navigation|import-form|import-request|import-request-body|import-upstream-request|import-upstream-response|import-response-delivery|import-response-status|import-response-settlement|import-response-(connect-(aborted|already-exists|canceled|data-loss|deadline-exceeded|failed-precondition|internal|invalid-argument|not-found|out-of-range|permission-denied|resource-exhausted|unauthenticated|unavailable|unimplemented|unknown)|http-(400|401|403|404|408|409|425|429|500|502|503|504|other-4xx|other-5xx))|import-contract|editor-navigation|editor-mount|first-canvas|first-image|first-annotations|first-publication-(request|confirmation|resource|contract)|second-image|second-canvas|second-annotations|second-overlay|second-publication-(request|resource|contract))$`)
	browserManifestSourceMarkerPattern          = regexp.MustCompile(`^browser readiness manifest source: (document-unavailable|hocr-unavailable|document-rejected|hocr-rejected)$`)
...
func ReadinessMarkerAllowed(kind Kind, line string) bool {
	...
	case KindBrowser:
		return browserMarkerPattern.MatchString(line) ||
			...
			browserManifestSourceMarkerPattern.MatchString(line) ||
