...
var (
	...
	browserManifestSubstageMarkerPattern        = regexp.MustCompile(`^browser readiness manifest substage: (library-navigation|import-form|import-request|import-request-body|import-upstream-request|import-upstream-response|import-response-delivery|import-response-status|import-response-settlement|import-response-(connect-(aborted|already-exists|deadline-exceeded|internal|resource-exhausted|unavailable|unknown)|http-(408|409|425|429|500|502|503|504))|import-contract|editor-navigation|editor-mount|first-canvas|first-image|first-annotations|first-publication|second-image|second-canvas|second-annotations|second-overlay|second-publication)$`)
