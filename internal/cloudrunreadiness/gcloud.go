...
var (
	...
	browserManifestSubstageMarkerPattern        = regexp.MustCompile(`^browser readiness manifest substage: (library-navigation|import-form|import-request|import-contract|editor-navigation|editor-mount|first-canvas|first-image|first-annotations|first-publication|second-image|second-canvas|second-annotations|second-overlay|second-publication)$`)
